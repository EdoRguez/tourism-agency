...
namespace TourismAgencyBack.Infrastructure.Migrations
{
    ...
    [Migration("20230519021557_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourismAgencyBack.Domain.BoatAggregate.Boat", b =>
                {
                    b.HasOne("TourismAgencyBack.Domain.BoatTypeAggregate.BoatType", null)
                        .WithMany()
                        .HasForeignKey("BoatTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TourismAgencyBack.Domain.Destinations.Destination", null)
                        .WithMany()
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("TourismAgencyBack.Domain.BoatAggregate.Entities.BoatImageURL", "ImageURLs", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
